 ...
 * Encodes cwd into a safe directory name under ~/.op-pi/agent/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.op-pi/agent/sessions/<encoded-cwd>/).
	 */
