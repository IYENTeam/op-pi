 ...
 *   1. Global settings (~/.op-pi/agent/settings.json)
 *   2. Project settings (.op-pi/settings.json)
 *   3. CLI override (passed directly to this function)
 *
 * Runtime approvals are stored separately in .op-pi/permissions-approved.jsonl
