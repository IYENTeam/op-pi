...
- The fork's compaction differs significantly from upstream pi (speculative + restoration + degradation are all op-pi additions). Upstream has a much simpler `core/compaction/` policy.
