...
All keyboard shortcuts can be customized via `~/.op-pi/agent/keybindings.json`. Each action can be bound to one or more keys.
...
Create `~/.op-pi/agent/keybindings.json`:
