> op-pi can create TUI components. Ask it to build one for your use case.
...
```typescript
import { getMarkdownTheme } from "@code-yeongyu/op-pi";
...
import { DynamicBorder } from "@code-yeongyu/op-pi";
...
Customize the inline working indicator shown while op-pi is streaming a response.
