...
8. **Project agents guidance:** the root `AGENTS.md` at the repo root (op-pi-mono coding guidelines) — fork strategy, commit conventions, anti-patterns.
